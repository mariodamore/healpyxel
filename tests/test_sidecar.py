...
def test_validate_nside_type_coercion():
...
class TestHealpixIDEdgeCases:
    ...
    def test_antimeridian_prefilter_order(self):
        """AD-008: geometry slightly outside minus_plus180 bounds still processed after fix."""
        poly = Polygon([(180, 1), (181, 1), (181, -1), (180, -1)])
        gdf = gpd.GeoDataFrame({"source_id": [1], "geometry": [poly]})
        result = process_partition(gdf, nside=32, mode="strict",
