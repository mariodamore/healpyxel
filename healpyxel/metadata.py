...
class HEALPyxelxMetadata:
    ...
    lon_convention: Literal['0_360', '-180_180', 'minus_plus180'] = '0_360'
    ...
    def __post_init__(self):
        ...
        # Normalize lon_convention: 'minus_plus180' → '-180_180'
        if self.lon_convention == 'minus_plus180':
            self.lon_convention = '-180_180'
