...
# %% auto 0
__all__ = ['logger', 'compute_healpix_ids_from_lonlat', 'detect_lonlat_columns', 'compute_geo_statistics',
           'format_geo_statistics', 'process_partition', 'build_output_path', 'write_sidecar_metadata',
           'validate_nside', 'parse_arguments', 'write_partitioned_output', 'write_coalesced_output', 'main']
...
def process_partition(gdf, nside: int, mode: str, base_index: int | None = None, 
                     lon_convention: str = 'None') -> pd.DataFrame:
