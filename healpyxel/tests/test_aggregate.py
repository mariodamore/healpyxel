# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/02_aggregate_test.ipynb.

# %% auto #0
__all__ = ['TestAggLookup', 'TestAggregateBySidecar', 'TestDensifyHealpixAggregates', 'TestGenerateOutputFilename',
           'TestExtractNsideFromFilename', 'TestValidateSidecarMetadata', 'TestCollectSidecarOutputs',
           'TestInteractiveSession']

# %% ../../nbs/02_aggregate_test.ipynb #8f0a3f10
import pytest
